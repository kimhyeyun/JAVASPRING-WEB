...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom {
    ...
    private BooleanExpression searchSellStatusEq(ItemSellStatus sellStatus) {
    ...
    private BooleanExpression searchByLike(String searchBy, String searchQuery) {
        ...
        else if(StringUtils.equals("createdBy",searchBy)) return QItem.item.createdBy.like("%" + searchQuery + "%");
