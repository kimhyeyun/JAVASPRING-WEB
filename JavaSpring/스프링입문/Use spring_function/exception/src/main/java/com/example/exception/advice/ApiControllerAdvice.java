...
public class ApiControllerAdvice {
    ...
    public ResponseEntity methodArgumentNotValidException(MethodArgumentNotValidException e, HttpServletRequest httpServletReqeu){
        ...
        errorResponse.setRequestUrl(httpServletReqeu.getRequestURI());
